...
class AzureGPT3_Reasoning_Graph_Baseline:
    def __init__(self, args):
        self.args = args
        self.data_path = args.data_path
        self.dataset_name = args.dataset_name
        self.split = args.split
        self.model_name = args.deployment_id
...
def parse_args():
    ...
    parser.add_argument('--api_type', type=str, default='azure_ad')
    parser.add_argument('--api_key', type=str, default=os.getenv("AZURE_OPENAI_API_KEY"))
    parser.add_argument('--api_base', type=str, default=os.getenv("ENDPOINT_URL") )
    parser.add_argument('--managed_identity_client_id', type=str)
    parser.add_argument('--api_version', type=str, default='2023-05-15')
    parser.add_argument('--deployment_id', type=str, default='gpt-4')
...
if __name__ == '__main__':
    ...
    # Initialize Azure OpenAI key token provier with Entra ID authentication
    credential = DefaultAzureCredential(managed_identity_client_id=args.managed_identity_client_id)
    token_provider = credential.get_token("https://cognitiveservices.azure.com/.default")
    # Set the OpenAI API key
    args.api_key = token_provider.token
    
    azure_gpt3_problem_reduction = AzureGPT3_Reasoning_Graph_Baseline(args)

    azure_gpt3_problem_reduction.reasoning_graph_generation()
    # azure_gpt3_problem_reduction.batch_reasoning_graph_generation(batch_size=10)